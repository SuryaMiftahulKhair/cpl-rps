...
export default function ResetPasswordModal({ open, onClose, user }: ResetPasswordModalProps) {
    const { register, handleSubmit, formState: { errors, isSubmitting }, reset } = useForm<ResetPasswordFormData>();
                ...
                <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden animate-in fade-in zoom-in duration-200">
                    ...
                    <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-amber-50/50">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-800 tracking-tight">Reset Password</h3>
                        ...
                        <button title="Tutup" onClick={onClose} className="text-gray-400 hover:text-amber-600 p-1 hover:bg-white rounded-full transition-all">
                            <X size={24}/>
                        </button>
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-5">
                        <div className="bg-amber-50 border border-amber-100 p-3 rounded-xl">
                            <p className="text-[11px] text-amber-800 leading-relaxed">
                                <strong>Perhatian:</strong> Admin dapat mereset password dosen jika dosen lupa. Berikan password ini kepada dosen yang bersangkutan setelah disimpan.
                            </p>
                        </div>
