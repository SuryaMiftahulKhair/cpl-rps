                ...
                {loading ? (
                  ...
                  <tr>
                    <td colSpan={5} className="px-6 py-20">
                      <div className="flex flex-col items-center justify-center text-center">
                        <div className="w-24 h-24 bg-linear-to-br from-indigo-100 to-blue-100 rounded-full flex items-center justify-center mb-5 shadow-inner">
                        ...
                        <p className="text-sm text-gray-500 mb-6 max-w-md">
                          Mulai dengan menambahkan kurikulum pertama untuk
                          program studi ini. Anda dapat mengelola Visi, Misi,
                          CPL, dan Mata Kuliah setelahnya.
                        </p>
                        <button
                          onClick={() => setIsModalOpen(true)}
                  ...
                  kurikulums.map((item, index) => (
                    <tr
                      ...
                      <td className="px-6 py-5">
                        <div className="inline-flex items-center gap-2.5 bg-linear-to-br from-indigo-500 to-indigo-600 text-white px-5 py-3 rounded-xl shadow-sm font-bold hover:shadow-md transition-shadow">
                      ...
                      <td className="px-6 py-5">
                        {item._count ? (
                          <div className="flex items-center gap-3">
                            {/* CPL Badge */}
                            <div className="flex items-center gap-1.5 bg-linear-to-r from-blue-50 to-blue-100 px-3 py-2 rounded-lg border border-blue-200 shadow-sm hover:shadow transition-shadow">
                            ...
                            {/* MK Badge */}
                            <div className="flex items-center gap-1.5 bg-linear-to-r from-amber-50 to-orange-100 px-3 py-2 rounded-lg border border-orange-200 shadow-sm hover:shadow transition-shadow">
