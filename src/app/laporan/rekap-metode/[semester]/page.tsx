...
// 1. REVISI INTERFACE: params harus dibungkus Promise
interface Props {
...
// 2. REVISI FUNGSI: Tambahkan async
export default async function SemesterDetail({ params }: Props) {
  // 3. REVISI AKSES: Await params sebelum digunakan
  const resolvedParams = await params;
  const raw = resolvedParams.semester;
  ...
  return (
    <DashboardLayout>
      <div className="p-6 lg:p-8">
        {/* ... Sisa kodingan UI Kakak tetap sama ... */}
        {/* ========== BREADCRUMB ========== */}
        ...
        {/* ========== SEMESTER INFO CARD ========== */}
        <div
          className={`bg-gradient-to-br ${colors.bg} rounded-2xl p-6 mb-6 border-2 ${colors.border} shadow-sm`}>
              ...
              <div className="p-6">
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-sm text-gray-500 max-w-md mx-auto mb-6">
                    Tabel atau grafik rekap metode penilaian untuk semester{" "}
                    {display} akan ditampilkan di sini.
                  </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-800">
                    Pastikan semua data kuisioner telah terverifikasi sebelum
