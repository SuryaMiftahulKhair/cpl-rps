...
import { Loader2, Filter, BarChart3, Search, TrendingUp, Award, BookOpen, Calendar } from "lucide-react"; 
          ...
          <div className="bg-white rounded-xl border-2 border-dashed border-gray-200 py-20">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="text-sm text-gray-500 max-w-md">
                Silakan pilih filter cakupan data dan periode, lalu klik tombol "Tampilkan Laporan" untuk melihat grafik dan analisis CPL
              </p>
            </div>
          </div>
        ) : (
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-bold text-gray-900">
                      {radarData.length > 0 
                        ? (radarData.reduce((sum, r) => sum + (r.prodi || 0), 0) / radarData.length).toFixed(1)
                        : '0'
                      }%
                    </p>
                  </div>
              ...
              <div className="lg:col-span-2 bg-white border border-gray-100 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="p-4 max-h-[468px] overflow-y-auto">
                  <div className="space-y-3">
                    {radarData.length > 0 ? radarData.map((item, idx) => {
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-2 text-xs">
                                <span className="text-gray-600">
                                  Capaian: <span className="font-bold text-indigo-600">{achievement.toFixed(1)}%</span>
                                </span>
                                <span className="text-gray-400">•</span>
                                <span className="text-gray-600">
                                  Target: <span className="font-bold text-red-600">{target}%</span>
                                </span>
                              </div>
                            </div>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {courseList.length === 0 ? (
                      <tr>
                        <td colSpan={3 + radarData.length} className="px-6 py-16">
                          <div className="flex flex-col items-center justify-center text-center">
                            <BookOpen size={48} className="text-gray-300 mb-3" />
                            <p className="text-sm font-medium text-gray-500">Tidak ada data mata kuliah</p>
                          </div>
                        </td>
                      </tr>
                    ) : (
