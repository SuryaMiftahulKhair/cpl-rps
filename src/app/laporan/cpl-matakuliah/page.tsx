        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 mb-6 overflow-hidden">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              {/* Dropdown 1: Matakuliah (REQUIRED) */}
          ...
          <div className="bg-white rounded-xl border-2 border-dashed border-gray-200 py-20">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <p className="text-sm text-gray-500 max-w-md">
                ...
                klik tombol "Tampilkan Laporan" untuk melihat grafik dan analisis
                CPL
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-gray-600 font-medium">Total CPL</p>
                    <p className="text-3xl font-bold text-gray-900">
                      {radarData.length}
                    </p>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-bold text-gray-900">
                      {radarData.length > 0
                        ? (
                            radarData.reduce((acc, item) => acc + item.prodi, 0) /
                            radarData.length
                          ).toFixed(1)
                        : "0"}
                      %
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
              ...
              <div className="lg:col-span-3 bg-white border border-gray-100 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="p-6">
                  {radarData.length > 0 ? (
                    <p className="text-sm text-gray-600">
                      Radar chart akan ditampilkan di sini. Data siap untuk visualisasi.
                    </p>
                  ) : (
                    <p className="text-center text-gray-400">Tidak ada data CPL</p>
                  )}
                </div>
              </div>
                  ...
                  <tbody>
                    {classDetails.length > 0 ? (
                      classDetails.map((cls, idx) => {
                        const avgScore =
                          Object.values(cls.scores).length > 0
                            ? (
                                Object.values(cls.scores).reduce(
                                  (a, b) => a + b,
                                  0
                                ) / Object.values(cls.scores).length
                              ).toFixed(1)
                            : 0;
