...
import { X, Printer, Loader2, Search, Users, Award, TrendingUp, BookOpen, Calendar, Filter, BarChart3, Target } from 'lucide-react';
...
export default function CPLMahasiswaPage() {
  ...
  // Calculate average
  const averageCPL = studentCPLData.length > 0 
    ? (studentCPLData.reduce((sum, item) => sum + item.nilai, 0) / studentCPLData.length).toFixed(1)
    : '0';
          ...
          <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl p-6 mb-6 border border-indigo-100">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-gray-900 mb-1">CPL Mahasiswa</h1>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 mb-6 overflow-hidden">
            ...
            <div className="border-b border-gray-100 px-6 py-4 bg-gradient-to-r from-gray-50 to-white">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-bold text-gray-900">Filter Data Mahasiswa</h3>
              </div>
            </div>
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wider">
                    {filterType === 'TAHUN' ? 'Pilih Tahun' : filterType === 'SEMESTER' ? 'Pilih Semester' : 'Periode'}
                  </label>
                  {filterType === 'SEMUA' ? (
                  ...
                  <table className="min-w-full">
                    <thead className="sticky top-0 z-10">
                      <tr className="border-b-2 border-gray-200">
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider bg-gray-50">No</th>
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider bg-gray-50">NIM</th>
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider bg-gray-50">Nama Mahasiswa</th>
                        <th className="px-6 py-4 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider bg-gray-50">Aksi</th>
                      </tr>
                    </thead>
                          ...
                          <td colSpan={4} className="px-6 py-16">
                            <div className="flex flex-col items-center justify-center text-center">
                              ...
                              <p className="text-sm text-gray-500 max-w-sm">
                                Silakan pilih filter dan klik "Tampilkan Data" untuk melihat daftar mahasiswa
                              </p>
                            </div>
                          </td>
                        </tr>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-blue-900 mb-2 text-sm">Filter Periode</h4>
                  <p className="text-xs text-blue-800 leading-relaxed">
                    Pilih cakupan data untuk melihat CPL mahasiswa berdasarkan periode tertentu
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <h4 className="text-xs font-bold text-gray-500 uppercase tracking-wider">Jenis Filter</h4>
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 text-sm mb-0.5">Per Semester</p>
                    <p className="text-xs text-gray-600">CPL dari mata kuliah semester tertentu saja</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 text-sm mb-0.5">1 Tahun Ajaran</p>
                    <p className="text-xs text-gray-600">Akumulasi semester Ganjil & Genap dalam satu tahun</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 text-sm mb-0.5">Keseluruhan</p>
                    <p className="text-xs text-gray-600">Total akumulasi dari semua mata kuliah yang pernah diambil</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="border-b border-gray-100 bg-gradient-to-r from-indigo-50 to-blue-50 px-6 py-5">
              <div className="flex justify-between items-start">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900">Capaian Pembelajaran Lulusan</h3>
                    <p className="text-sm text-gray-600 mt-1">
                      <span className="font-semibold">{selectedStudent.nama}</span> 
                      <span className="mx-2">•</span>
                      <span className="font-mono bg-white px-2 py-0.5 rounded border border-gray-200">{selectedStudent.nim}</span>
                    </p>
                  </div>
                </div>
              ...
              {loadingCPL ? (
                <div className="flex h-96 items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-sm font-medium text-gray-600">Memuat data CPL...</p>
                  </div>
                </div>
              ) : (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Total CPL</p>
                          <p className="text-2xl font-bold text-gray-900">{studentCPLData.length}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Rata-rata</p>
                          <p className="text-2xl font-bold text-gray-900">{averageCPL}%</p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-lg font-bold text-emerald-600">
                            {parseFloat(String(averageCPL)) >= 75 ? 'Sangat Baik' : parseFloat(String(averageCPL)) >= 60 ? 'Baik' : 'Perlu Peningkatan'}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
                    <div className="border-b border-gray-100 px-6 py-4 bg-gradient-to-r from-gray-50 to-white">
                      <h4 className="font-bold text-gray-900">Detail Capaian Per CPL</h4>
                    </div>
                            ...
                            <tr key={idx} className="hover:bg-gray-50 transition-colors">
                              ...
                              <td className="px-6 py-4 text-center w-40">
                                <span className={`inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold border ${
                                  ...
                                  {item.nilai >= 75 ? '✓ Sangat Baik' : item.nilai >= 60 ? '⚠ Baik' : '✗ Perlu Ditingkatkan'}
                                </span>
                              </td>
                            </tr>
                          ))}
