/*
  ...
  - You are about to drop the `CPL` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `Kurikulum` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "public"."CPL" DROP CONSTRAINT "CPL_mataKuliahId_fkey";

-- DropForeignKey
ALTER TABLE "public"."Kurikulum" DROP CONSTRAINT "Kurikulum_programStudiId_fkey";

-- DropForeignKey
ALTER TABLE "public"."MataKuliah" DROP CONSTRAINT "MataKuliah_kurikulumId_fkey";

-- DropForeignKey
ALTER TABLE "public"."VisiMisi" DROP CONSTRAINT "VisiMisi_kurikulumId_fkey";
...
-- DropTable
DROP TABLE "public"."ProgramStudi";

-- DropTable
DROP TABLE "public"."VisiMisi";
